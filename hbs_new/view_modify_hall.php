            ...
            <div class="card shadow-lg mt-5">
                ...
                <!-- style="border: 1px solid;" -->
                    <table class="table table-bordered" >
                        <thead>
                        <center><h3 style="color:#0e00a3">Hall Deatils</h3>             
                        <input type="text" id="searchInput" style="width: 50%;" class="place" placeholder="Search your package" oninput="fetchPackages()">
                        <br>
                        </center>
                            <tr>
                                <th style="padding: 15px; width:10%;">Date</th>
                                <th style="padding: 15px; width:15%;">Hall Details</th>
                                <th style="padding: 15px; width:20%;">Belongs to</th>
                                <th style="padding: 15px; width:15%;">Incharge Details</th>
                                <th style="padding: 15px; width:5%;">Availability</th>
                                <th style="padding: 15px; width:20%;">Features</th>
                                <th style="padding: 15px; width:10%;">Actions</th>
                            </tr>
                        </thead>
                        <tbody class="search_hall">
                            <?php
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-outline-success" style="background: #78d278; padding: 6px 15px; border-radius: 10px; margin-bottom: 5px; border:0;">
                                                <a href="modify_hall.php?id=<?php echo $row['hall_id']; ?>" style="color:black; padding:0;">View/Modify</a>
                                            </button>
                                            <button style="background: #df9f66; padding: 6px 0px; border-radius: 10px; border:0;">
...
<script>
    function fetchPackages() {
        ...
        $.ajax({
            url: "fetch_searchedroom.php", // Create this PHP file for the search functionality
            type: "POST",
            data: { search: searchTerm },
            success: function (data) {
                $(".search_hall").html(data);
            }
        });
    }
</script>
