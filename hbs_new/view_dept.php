...
<body>
    ...
    <thead>
        <tr>
            <th style="background-color: #ecec82; width:5%;">SL</th>
            <th style="background-color: #ecec82; width:30%;">School</th>
            <th style="background-color: #ecec82; width:40%;">Department</th>
            <th style="background-color: #ecec82; width:15%;">Action</th>
        </tr>
    </thead>
    <tbody>
