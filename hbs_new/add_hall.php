...
<body>
    ...
    <div class="main-content mt-3">
        ...
        <form action="insert.php" id="myForm" method="post" style="margin:20px 150px; background-color:white; padding: 50px; border-radius:15px;" enctype="multipart/form-data">
            <h2 class="mb-4" style="color:#4c37dc; text-align:center;">Add Hall</h2>
            ...
            <label class="form-label mt-1" for="room_name"> Name:</label>
            ...
            <input type="text" name="incharge_name" placeholder="Enter Incharge name">
            ...
            <input type="email" name="incharge_email" placeholder="Enter Incharge email">

            <label class="form-label">Incharge Phone Number</label>
            <input type="number" name="phoneNumber" placeholder="Enter Incharge Contact Number">
